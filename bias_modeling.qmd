...
**KH**: Can you expand upon the statement that crime data does not exist?  I think the audience might benefit from 2-3 more sentences here.  
...
The resulting bias in recorded crime data affects both the risk factors used as predictors in a risk assessment tool, and the outcomes predicted by a risk assessment tool -- such as failure to appear for court or new criminal activity during the pretrial period. An assessment that depends on risk factors that are biased may perpetuate this bias because it could score a Black defendant as at higher risk than a White defendant with the same true level of risk.

**KH** are failure to appear for court and new criminal activity predictors, outcomes, or both?
...
**KH**: what do you mean by the evaluation of the risk assessment? I could use some more explanation as what process is going on here.
...
**KH**: when you say it predicts an outcome "better" do you mean "more accurately"? Can you explain what a pending charge is?  Is it binary or categorical? If the model is more accurate for White than Black people, does that necessarily mean Black people will get a higher score, or just that they are more likely to get an inaccurate score, where the error could be in either direction?  
...
The problem intensifies when the risk assessment tools, designed from the non-detained population, are applied universally---to both those who would be detained and not. This application can lead to inaccuracies if those detained exhibit systematic differences from those not detained, leading to models that do not effectively predict the risk levels of the detained population.

**KH**: here you say the problem intensifies, but you have not yet stated what the problem is with differential censoring.
