...
![](images/head_equityResults.png){width="7in"}

And then the next code chunk (`fairnessDiffExploration`) helps the user output from the previous chunk so that differential metrics can be assessed. 
