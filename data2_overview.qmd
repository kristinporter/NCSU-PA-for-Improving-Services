...
-   There may be mistakes or nonsensical values that create noise and obfuscates underlying patterns;

-   There may be valuable information that needs to be extracted from raw measures that may not provide clear empirical meaning (e.g. text data); and
