...
**KH**: not sure someone who is unfamiliar with ROC curves will understand the paragraph above about ranks.
...
**KH**: there's a typo below, but not sure what the correct version is: "AUC-PR is a valuable metric when there is class"
