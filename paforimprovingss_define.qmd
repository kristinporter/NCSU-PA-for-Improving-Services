...
-   The complexity of PA may vary. For example, PA may rely on relatively simple approaches, such as models with a small number of measures. Alternatively, in settings with large amounts of data, they may involve complex machine-learning algorithms.

**KH**: I wonder if "measure" is a confusing term?  Also if a linear regression has a large number of variables, would you say that isn't a simple approach?
...
**KH**: I avoid using the term "likelihood" unless I mean it in the technical statistical sense of a likelihood function.
