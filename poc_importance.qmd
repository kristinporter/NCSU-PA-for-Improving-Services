...
**KH**: not every setting predicts who is at-risk, but I'm not sure how to modify this so that it's more general but still clear.
...
**KH** I'm not sure where to introduce this concept--I probably should have made a comment earlier--but I think it's important to remind the students there are multiple definitions of bias.  Statistical bias does not always match our usual English definition of bias.  Algorithmic bias can also take many forms, and is a bit fuzzy.  For example, if an algorithm predicts Black people are more at-risk, and that prediction matches the true underlying population risk, is that "bias"? For these reasons I tend toward using terms like "equity" or "fairness" but those have their own problems as well.
