...
[Informed Consent:]{style="color:red"} Related to data privacy is the issue of informed consent from individuals whose data are being used for predictive analytics. Informed consent is not always necessary but should be thoroughly considered in many scenarios.
...
**KH**: a topic that I have not thought about much is people manipulating PA systems.  Christoph Molnar has a paragraph about this (see the last paragraph in this section)

[https://christophm.github.io/interpretable-ml-book/interpretability-importance.html](https://christophm.github.io/interpretable-ml-book/interpretability-importance.html)
