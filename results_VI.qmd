...
variety of methods focused on "variable importance."

### The value of variable importance

Variable importance is helpful for understanding and explaining a
predictive model. Variable importance methods also answer a set of
related questions. Sometimes these related questions are what is most of
interest.
...
There are a wide-range of methods for estimating variable importance.
...
\
Variable importance methods may also be "model-driven" or
"parameter-driven."
