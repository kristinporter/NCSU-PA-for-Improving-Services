...
Recall our goal of predictive analytics, as shown in this simply illustration: We use use data with known outcomes to build a model that allows us to predict outcomes - or the likelihood of outcomes in data with unknown outcomes. 
