...
-   **Challenged with highly correlated predictors:** With highly correlated predictors, lasso arbitrarily chooses which to include in the model. This may not matter for predictive performance but can interfere with explainability.
